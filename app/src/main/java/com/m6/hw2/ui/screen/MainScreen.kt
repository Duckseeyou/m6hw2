...
import com.m6.hw2.ui.activity.CustomNavController
    ...
    Column(
        ...
        val detectiveBookList = listOf(
            ...
            BookModel(
                ...
                "https://simg.marwin.kz/media/catalog/product/cache/8d1771fdd19ec2393e47701ba45e606d/c/o/cover1__w600_144_151.jpg"
            ),
            BookModel(
        ...
        val classicsBooksList = listOf(
            BookModel(
                ...
                "Рэй Брэдбери",
                "Научно-фантастический роман-антиутопия, изданный в 1953 году. Роман описывает американское общество близкого будущего, в котором книги находятся под запретом; «пожарные», к числу которых принадлежит и главный герой Гай Монтэг, сжигают любые найденные книги.",
                "https://cdn.eksmo.ru/v2/ITD000000001281246/COVER/cover1__w600.jpg"
            ),
            BookModel(
                "Маленький принц",
